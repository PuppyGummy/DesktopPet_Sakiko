...
namespace SatorImaging.AppWindowUtility
{
    public class Windows : IPlatformDependent
    {
        ...
        public static bool ClickThroughPixel { get; set; } = false;
        ...
        public void SetClickThrough(bool enable)
        {
            ...
            if (enable)
            {
                uint newStyle = currExStyle | WinApi.WS_EX_LAYERED | WinApi.WS_EX_TRANSPARENT;
            ...
            {
                WinApi.SetWindowLong(hWnd, WinApi.GWL_EXSTYLE, currExStyle & ~WinApi.WS_EX_TRANSPARENT);
            }
        ...
        public static void HideFromTaskbar()
        {
            uint exStyle = WinApi.GetWindowLong(hWnd, WinApi.GWL_EXSTYLE);
